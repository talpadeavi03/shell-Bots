...
def query_ai(user_input, purpose):
    try:
        ...
        data = {
            ...
            "messages": [
                {"role": "system", "content": "You are an AI assistant that converts natural language into valid Linux commands and answers questions. Only return the command if asked to run."},
